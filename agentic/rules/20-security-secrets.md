...
- **HashiCorp Vault**: deferred by template-ADR-001 (revisit trigger: IRSA/WI insufficient)
- **SLSA Level 3+**: requires hermetic builds — out of scope for template
- **Compliance programs (SOC2/HIPAA)**: organizational, not template (template-ADR-001)
