...
The retrain workflow will execute C/C (template-ADR-008) — do not assume promotion.
...
- It does NOT promote or demote models (that is `model-retrain` + template-ADR-008).
