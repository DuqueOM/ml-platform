...
from llm_core.config import UsecaseConfig
from llm_core.schemas import Observation
...
def build_registry(config: UsecaseConfig) -> ToolRegistry:
    ...
    def order_create(items: list[dict[str, Any]], customer_phone: str, **kwargs: Any) -> Observation:
