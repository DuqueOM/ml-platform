...
**Canonical source**: `agentic/rules/15-template-lifecycle.md`

Read the canonical source in full before acting. This file is a thin
adapter pointer and must not duplicate policy text.

To change this rule, edit `agentic/rules/15-template-lifecycle.md`, update the manifest when needed,
then run:
