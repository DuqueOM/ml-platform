...
**Mode**: `AUTO`
**Canonical source**: `agentic/skills/enterprise-audit/SKILL.md`

Read `agentic/skills/enterprise-audit/SKILL.md` in full before invoking this skill. The canonical
