...
```bash
echo "demand_forecast_serving_monthly_cloud_cost_usd ${TOTAL_MONTHLY_COST_USD}" | \
  curl --data-binary @- \
  "${PUSHGATEWAY_URL:-http://pushgateway:9091}/metrics/job/cost-audit/service/demand_forecast_serving"
```
