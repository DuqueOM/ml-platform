...
grep -r "Demand Forecast Serving\|demand_forecast_serving\|" ${SVC_NAME}/ --include="*.py" --include="*.yaml" | head -10
```
...
find ${SVC_NAME}/ -type f -exec sed -i "s/demand_forecast_serving/${SVC_SLUG}/g" {} +
