"""Command-line interface for Demand Forecast Serving.
...
Usage:
    python -m src.demand_forecast_serving.cli train --config configs/config.yaml --input data/raw/train.csv
    python -m src.demand_forecast_serving.cli evaluate \
        --config configs/config.yaml --input data/raw/test.csv --model models/model.joblib
    python -m src.demand_forecast_serving.cli predict \
        --input data/new.csv --output results/predictions.csv --model models/model.joblib

TODO: Rename imports from src.demand_forecast_serving to your actual service package name.
"""
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Demand Forecast Serving — ML prediction system",
