"""Configuration management for Demand Forecast Serving.
...
TODO: Rename ServiceConfig → Demand Forecast ServingConfig (e.g., ChurnConfig).
...
class MLflowConfig(BaseModel):
    ...
    experiment_name: str = "Demand Forecast Serving-Production"
    enabled: bool = True
...
# ---------------------------------------------------------------------------
# TODO: Rename to Demand Forecast ServingConfig.
